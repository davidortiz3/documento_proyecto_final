...
Q_CONSTINIT static const qt_meta_stringdata_CLASSarmaENDCLASS_t qt_meta_stringdata_CLASSarmaENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 14),  // "QGraphicsItem*"
        QT_MOC_LITERAL(30, 5),  // "shoot"
        QT_MOC_LITERAL(36, 4),  // "item"
        QT_MOC_LITERAL(41, 6),  // "limite"
        QT_MOC_LITERAL(48, 4)   // "move"
    },
    "arma",
    "colision",
    "",
...
void arma::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->limite((*reinterpret_cast< std::add_pointer_t<QGraphicsItem*>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = bool (arma::*)(QGraphicsItem * , int );
            if (_t _q_method = &arma::colision; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = bool (arma::*)(QGraphicsItem * );
            if (_t _q_method = &arma::limite; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
bool arma::colision(QGraphicsItem * _t1, int _t2)
{
    bool _t0{};
...
// SIGNAL 1
bool arma::limite(QGraphicsItem * _t1)
{
    bool _t0{};
